  ...
  return (
    <div className="cars__years">
      ...
      <div className="cars__search">
        <input onChange={(e)=> setSearchValue(e.target.value)} value={searchValue} placeholder="2000..." type="text" />
        {searchValue && <img onClick={()=> setSearchValue('')} className="cars__close" src={closeSvg} alt="" />}
      </div>
